...
function loadPlayersPage()
{
    ...
    for(var i=0; i<players.length; i++)
    {
        ...
        inject= inject + "<a class = 'dropdown-item' href='#' onclick = 'switchPlayers("+ i +")'>" + player +"</a>"
    }
    playermenu.innerHTML=inject;
}
...
function switchPlayers(playerNum)
{
    ...
    var passes=Math.floor(players[playerNum].pass_yards/players[playerNum].games_played);
    var rushes=Math.floor(players[playerNum].rushing_yards/players[playerNum].games_played);
    var catches=Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
    document.getElementById("avg_p_yards").innerHTML=passes;
    document.getElementById("avg_r_yards").innerHTML=rushes;
    document.getElementById("avg_rec_yards").innerHTML=catches;
}
